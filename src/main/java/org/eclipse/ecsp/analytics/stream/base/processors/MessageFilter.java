...
/**
 * Contract for custom message filter to identify duplicate message.
 *
 * @author MaKumari
 */
public interface MessageFilter {
     ...
     * @return key Unique string used as key in ignite cache to identify the dupilcate message
     */
