...
public class PropertyNames {
    ...
    public static final String DEVICE_MESSAGING_EVENT_TRANSFORMER =
            "device.messaging.event.transformer.class";
    ...
    public static final String SHARED_DATA_SOURCE_CONNECTION_PER_HOST =
            "shared.data.source.connection.per.host";

    /** The Constant SHARED_DATA_SOURCE_CONNECTION_TIMEOUT. */
    public static final String SHARED_DATA_SOURCE_CONNECTION_TIMEOUT =
            "shared.data.source.connection.timeout";
    ...
    public static final String MONGO_CLIENT_CONNECTION_TIMEOUT_MS =
            "db.client.connection.timeout.ms";
    ...
    /** The Constant DEFAULT_MONGODB_POOL_MAX_SIZE. */
    private static final String DEFAULT_MAX_WAIT_TIME_MS = "30000";

    /** The Constant DEFAULT_MONGO_CLIENT_MAX_WAIT_TIME_MS. */
    private static final String DEFAULT_CONNECT_TIMEOUT_MS = "20000";

    /** The Constant DEFAULT_MONGO_CLIENT_CONNECTION_TIMEOUT_MS. */
    private static final String DEFAULT_SOCKET_TIMEOUT_MS = "60000";

    /** The Constant DEFAULT_MONGO_CLIENT_SOCKET_TIMEOUT_MS. */
    ...
    public static final String KAFKA_CLIENT_TRUSTSTORE_PASSWORD =
    ...
    public static final String KAFKA_DELIVERY_TIMEOUT_MS_CONFIG =
            "kafka.delivery.timeout.ms.config";
    ...
    public static final String IGNITE_PLATFORM_SERVICE_IMPL_CLASS_NAME =
    ...
    public static final String MQTT_SERVICE_TRUSTSTORE_PASSWORD =
    ...
    public static final String MQTT_GLOBAL_BROADCAST_RETENTION_TOPICS =
    ...
    public static final String HEALTH_MQTT_MONITOR_RESTART_ON_FAILURE =
            "health.mqtt.monitor.restart.on.failure";
    ...
    public static String getDefaultPropertyValue(String propertyName) {
        ...
        throw new PropertyNotFoundException(
                "Property " + propertyName + " doesn't exist in the default list.");
    }
    ...
    /**
     * The Constant DMA_AUTO_OFFSET_RESET_CONFIG. Specifies the auto offset reset configuration for
     * DMA.
     */
    public static final String DMA_AUTO_OFFSET_RESET_CONFIG = "dma.auto.offset.reset";

    /**
     * The Constant DMA_EVENT_HEADER_UPDATION_TYPE. Specifies the header updation type for DMA
     * events.
     */
    public static final String DMA_EVENT_HEADER_UPDATION_TYPE = "dma.event.header.updation.type";

    /**
     * The Constant DMA_SERVICE_MAX_RETRY. Specifies the maximum retry count for DMA service.
     */
    public static final String DMA_SERVICE_MAX_RETRY = "dma.service.max.retry";

    /**
     * The Constant DMA_SERVICE_DEFAULT_EVENT_RETRY_INTERVAL. Specifies the default retry interval
     * for DMA service events.
     */
    public static final String DMA_SERVICE_DEFAULT_EVENT_RETRY_INTERVAL =
            "dma.service.default.event.retry.interval";

    /**
     * The Constant DMA_SERVICE_MAX_POLLING_INTERVAL_MILLIS. Specifies the maximum polling interval
     * in milliseconds for DMA service.
     */
    public static final String DMA_SERVICE_MAX_POLLING_INTERVAL_MILLIS =
            "dma.service.max.polling.interval.millis";

    /**
     * The Constant DMA_SHOULDER_TAP_INVOKER_IMPL_CLASS. Specifies the implementation class for DMA
     * shoulder tap invoker.
     */
    public static final String DMA_SHOULDER_TAP_INVOKER_IMPL_CLASS =
            "dma.shoulder.tap.invoker.impl.class";

    /**
     * The Constant DMA_SHOULDER_TAP_INVOKER_WAM_SEND_SMS_URL. Specifies the WAM send SMS URL for
     * DMA shoulder tap invoker.
     */
    public static final String DMA_SHOULDER_TAP_INVOKER_WAM_SEND_SMS_URL =
            "dma.shoulder.tap.invoker.wam.send.sms.url";

    /**
     * The Constant DMA_SHOULDER_TAP_WAM_SEND_SMS_URL. Specifies the URL for DMA shoulder tap WAM
     * send SMS.
     */
    public static final String DMA_SHOULDER_TAP_WAM_SEND_SMS_URL =
            "dma.shoulder.tap.invoker.wam.send.sms.url";

    /**
     * The Constant DMA_SHOULDER_TAP_INVOKER_WAM_SMS_TRANSACTION_STATUS_URL. Specifies the WAM SMS
     * transaction status URL for DMA shoulder tap invoker.
     */
    ...
    /**
     * The Constant DMA_SHOULDER_TAP_WAM_SMS_PRIORITY. Specifies the priority for DMA shoulder tap
     * WAM SMS.
     */
    public static final String DMA_SHOULDER_TAP_WAM_SMS_PRIORITY =
            "dma.shoulder.tap.wam.sms.priority";

    /**
     * The Constant DMA_SHOULDER_TAP_WAM_SMS_VALIDITY_HOURS. Specifies the validity hours for DMA
     * shoulder tap WAM SMS.
     */
    public static final String DMA_SHOULDER_TAP_WAM_SMS_VALIDITY_HOURS =
            "dma.shoulder.tap.wam.sms.validity.hours";

    /**
     * The Constant DMA_SHOULDER_TAP_WAM_SEND_SMS_SKIP_STATUS_CHECK. Specifies whether to skip
     * status check for DMA shoulder tap WAM send SMS.
     */
    ...
    /**
     * The Constant DMA_SHOULDER_TAP_WAM_API_MAX_RETRY_COUNT. Specifies the maximum retry count for
     * DMA shoulder tap WAM API.
     */
    public static final String DMA_SHOULDER_TAP_WAM_API_MAX_RETRY_COUNT =
            "dma.shoulder.tap.wam.api.max.retry.count";

    /**
     * The Constant DMA_SHOULDER_TAP_WAM_API_MAX_RETRY_INTERVAL_MS. Specifies the maximum retry
     * interval in milliseconds for DMA shoulder tap WAM API.
     */
    ...
    public static final String DMA_TTL_EXPIRY_NOTIFICATION_ENABLED =
            "dma.ttl.expiry.notification.enabled";

    /** The Constant DMA_REMOVE_ON_TTL_EXPIRY_ENABLED. */
    public static final String DMA_REMOVE_ON_TTL_EXPIRY_ENABLED =
            "dma.remove.on.ttl.expiry.enabled";
    ...
    /**
     * Properties required to make use of the following DMA capabilities: 1. Dispatch to kafka
     * broker. 2. Retrieve connection status of devices from a third party API
     */
    ...
    /**
     * The Constant DMA_CONNECTION_STATUS_API_RETRY_INTERVAL_MS. Specifies the retry interval in
     * milliseconds for DMA connection status API.
     */
    ...
    public static final String DMA_CONNECTION_STATUS_PARSER_IMPL =
            "dma.connection.status.parser.impl";

    /**
     * The Constant DMA_CONNECTION_MSG_VALUE_TRANSFORMER. Specifies the value transformer for DMA
     * connection messages.
     */
    ...
    /**
     * The Constant DMA_CONNECTION_MSG_KEY_TRANSFORMER. Specifies the key transformer for DMA
     * connection messages.
     */
    public static final String DMA_CONNECTION_MSG_KEY_TRANSFORMER =
            "dma.connection.msg.key.transformer";
    ...
    public static final String SHOULDER_TAP_RETRY_INTERVAL_MILLIS =
            "shoulder.tap.retry.interval.millis";

    /** The Constant SHOULDER_TAP_RETRY_MIN_THRESHOLD_MILLIS. */
    public static final String SHOULDER_TAP_RETRY_MIN_THRESHOLD_MILLIS =
            "shoulder.tap.retry.min.threshold.millis";

    /** The Constant SHOULDER_TAP_RETRY_INTERVAL_DIVISOR. */
    public static final String SHOULDER_TAP_RETRY_INTERVAL_DIVISOR =
            "shoulder.tap.retry.interval.divisor";

    /** The Constant FILTER_DM_OFFLINE_BUFFER_ENTRIES_IMPL. */
    public static final String FILTER_DM_OFFLINE_BUFFER_ENTRIES_IMPL =
            "filter.dmoffline.buffer.entry.impl";
    ...
    public static final String CACHE_BYPASS_THREADS_SHUTDOWN_WAIT_TIME =
            "cache.bypass.threads.shutdown.wait.time";

    /** The Constant CACHE_BYPASS_QUEUE_INITIAL_CAPACITY. */
    public static final String CACHE_BYPASS_QUEUE_INITIAL_CAPACITY =
            "cache.bypass.queue.initial.capacity";

    /** The Constant DMA_CONNECTION_STATUS_RETRIEVER_IMPL. */
    public static final String DMA_CONNECTION_STATUS_RETRIEVER_IMPL =
            "dma.connection.status.retriever.impl";
    ...
    /**
     * RTC 334625 Configuration for maxFailures and maxTimeInterval to be used to recover the
     * thread.
     */
    ...
    public static final String FETCH_CONNECTION_STATUS_TOPIC_NAME =
            "fetch.connection.status.topic.name";

    /** The Constant CONVERT_BACKDOOR_KAFKA_TOPIC_TO_LOWERCASE. */
    public static final String CONVERT_BACKDOOR_KAFKA_TOPIC_TO_LOWERCASE =
            "convert.backdoor.kafka.topic.tolowercase";
    ...
    public static final String BACKDOOR_KAFKA_MAX_POLL_INTERVAL_MS =
            "backdoor.kafka.max.poll.interval.ms";

    /** The Constant BACKDOOR_KAFKA_REQUEST_TIMEOUT_MS. */
    public static final String BACKDOOR_KAFKA_REQUEST_TIMEOUT_MS =
            "backdoor.kafka.request.timeout.ms";

    /** The Constant BACKDOOR_KAFKA_SESSION_TIMEOUT_MS. */
    public static final String BACKDOOR_KAFKA_SESSION_TIMEOUT_MS =
            "backdoor.kafka.session.timeout.ms";
    ...
    /**
     * Below flag is used in case of message filter to identify the message duplicates.
     */
    ...
    /**
     * Below flag is used to enabling streaming of event size to kafka for analytics dashboard
     * RTC-301848.
     */
    ...
    public static final String KAFKA_DATA_CONSUMPTION_METRICS_KAFKA_TOPIC =
            "data.consumption.metrics.kafka.topic";
     ...
     * it must let DMA know about all those through below property by assigning comma separated
     * values of names of sub-services.
     */
    ...
    public static final String ROCKSDB_METRICS_THREAD_INITIAL_DELAY_MS =
            "rocksdb.metrics.thread.initial.delay.ms";

    /** The Constant ROCKSDB_METRICS_THREAD_FREQUENCY_MS. */
    public static final String ROCKSDB_METRICS_THREAD_FREQUENCY_MS =
            "rocksdb.metrics.thread.frequency.ms";
     ...
     * RDNG 171813.
     */
    public static final String KAFKA_TOPIC_NAME_PLATFORM_PREFIXES =
            "kafka.topic.name.platform.prefixes";
    ...
    /**
     * The Constant MQTT_SERVICE_TRUSTSTORE_PASSWORD_SUFFIX. Specifies the suffix for MQTT service
     * truststore password.
     */
    public static final String MQTT_SERVICE_TRUSTSTORE_PASSWORD_SUFFIX =
            ".service.truststore.password";

    /**
     * The Constant MQTT_SERVICE_TRUSTSTORE_TYPE_SUFFIX. Specifies the suffix for MQTT service
     * truststore type.
     */
