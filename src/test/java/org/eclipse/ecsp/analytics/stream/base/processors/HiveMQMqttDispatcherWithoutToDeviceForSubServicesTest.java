...
/**
 * class {@link HiveMQMqttDispatcherWithoutToDeviceTestForSubServices}.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = { Launcher.class })
@EnableRuleMigrationSupport
@TestPropertySource("/hivemq-test-mqtt-sub-services.properties")
public class HiveMQMqttDispatcherWithoutToDeviceForSubServicesTest {
    ...
    public void testWithCustomMqtttopicForSubServices() {
        ...
        value = new DeviceMessage(transformer.toBlob(event), Version.V1_0,
                event, "feedBackTopic", Constants.THREAD_SLEEP_TIME_60000);
        ...
        // consecutive ones
        mqttTopic = defaultMqttTopicNameGeneratorImpl.getMqttTopicName(new TestKey(), 
                value.getDeviceMessageHeader(), null);
