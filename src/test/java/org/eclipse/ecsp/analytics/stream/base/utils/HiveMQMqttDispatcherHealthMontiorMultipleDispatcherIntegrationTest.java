...
/**
 *  class HiveMQMqttDispatcherHealthMontiorMultipleDispatcherIntegrationTest
 *         extends KafkaStreamsApplicationTestBase.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = { Launcher.class })
@EnableRuleMigrationSupport
@TestPropertySource("/hivemq-mqtt-health-monitor.properties")
public class HiveMQMqttDispatcherHealthMontiorMultipleDispatcherIntegrationTest extends 
    ...
    public void testMqttHealthMonitorIntegration() {
        ...
        Assert.assertFalse(monitor.isHealthy(false));
        Assert.assertTrue(monitor.isHealthy(true));
