...
@TestPropertySource("/test-mqtt-without-topic-prefix.properties")
public class MqttDispatcherWithoutTopicPrefixIntegrationTest {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(MqttDispatcherWithoutTopicPrefixIntegrationTest.class);
     ...
     */
    @Test
    public void testClientConnection_without_topic_pefix() throws InterruptedException, MqttException {
