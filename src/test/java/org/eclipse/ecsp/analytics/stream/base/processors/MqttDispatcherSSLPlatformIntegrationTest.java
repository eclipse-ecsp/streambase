...
@TestPropertySource("/test-mqtt-ssl-platform.properties")
public class MqttDispatcherSSLPlatformIntegrationTest {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(MqttDispatcherSSLPlatformIntegrationTest.class);
    ...
    public void testClientConnection_without_topic_pefix() throws MqttException {
         ...
         */
        String mqttTopicToSubscribe =
            defaultMqttTopicNameGeneratorImpl.getMqttTopicName(key, value.getDeviceMessageHeader(), null).get();
