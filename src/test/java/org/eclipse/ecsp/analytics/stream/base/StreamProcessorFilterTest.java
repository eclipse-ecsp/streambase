...
public class StreamProcessorFilterTest extends KafkaStreamsApplicationTestBase {
    ...
    /**
     * Testing Processor chaining with PRE_PROCESSORS and POST_PROCESSORS as included in the chain.
     *
     * @throws Exception the exception
     */
    @Test
    public void testStreamProcessorFilterAsEnabled() throws Exception {
        ksProps.put(PropertyNames.PRE_PROCESSORS, StreamPreProcessorEnabled.class.getName());
        ksProps.put(PropertyNames.POST_PROCESSORS, StreamPostProcessorEnabled.class.getName());
        ...
        Assert.assertEquals("value1_StreamPreProcessor_StreamPostProcessor",
                messages.get(0)[1]);
    }

    /**
     * Testing Processor chaining with PRE_PROCESSORS and POST_PROCESSORS as not  included in the chain.
     *
     * @throws Exception the exception
     */
    @Test
    public void testStreamProcessorFilterAsNotEnabled() throws Exception {
        ksProps.put(PropertyNames.PRE_PROCESSORS, StreamPreProcessorDisabled.class.getName());
        ksProps.put(PropertyNames.POST_PROCESSORS, StreamPostProcessorDisabled.class.getName());
        ksProps.put(PropertyNames.APPLICATION_ID, "chaining" + System.currentTimeMillis());
        launchApplication();
        KafkaTestUtils.sendMessages(inTopicName, producerProps, "key1", "value1");
        List<String[]> messages = KafkaTestUtils.getMessages(outTopicName, consumerProps, 1,
    ...
    /**
     * StreamPreProcessorEnabled class implements {@link StreamProcessorFilter}.
     **/
    public static final class StreamPreProcessorEnabled implements
            StreamProcessor<byte[], byte[], byte[], byte[]>, StreamProcessorFilter {
    ...
    /**
     * StreamPostProcessorEnabled implements {@link StreamProcessorFilter}.
     **/
    public static final class StreamPostProcessorEnabled implements
            StreamProcessor<byte[], byte[], String, String>, StreamProcessorFilter {
    ...
    /**
     * StreamPreProcessorDisabled implements {@link StreamProcessor}.
     **/
    public static final class StreamPreProcessorDisabled
            implements StreamProcessor<byte[], byte[], byte[], byte[]>, StreamProcessorFilter {
    ...
    /**
     * StreamPostProcessorDisabled implements {@link StreamProcessor}.
     **/
    public static final class StreamPostProcessorDisabled
            implements StreamProcessor<byte[], byte[], String, String>, StreamProcessorFilter {
