 ...
 */
public class MqttServer extends ExternalResource {
    
    /** The logger. */
    private static IgniteLogger logger = IgniteLoggerFactory.getLogger(MqttServer.class);
    ...
    /**
     * MqttServer: public constructor.
     */
    public MqttServer() {
        logger.info("Loading mqtt Server Config:{}", "/mqtt.conf");
        this.mqttServer = new Server();
        this.configFile = this.getClass().getResource("/mqtt.conf").getFile();
    }
