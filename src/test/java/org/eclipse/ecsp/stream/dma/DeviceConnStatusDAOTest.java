...
public class DeviceConnStatusDAOTest {
    ...
    public void testDeviceStatusDAO() {
        ...
        deviceStatusCacheBackedInMemoryDAO.putToMap(DeviceStatusKey.getMapKey(serviceName),
                deviceStatusKey, mapping, null,
        ...
        deviceStatusCacheBackedInMemoryDAO.deleteFromMap(DeviceStatusKey.getMapKey(serviceName),
                deviceStatusKey, null, InternalCacheConstants.CACHE_TYPE_DEVICE_CONN_STATUS_CACHE);
    ...
    public void testSyncWithCache() {
        ...
        Mockito.when(cache.getMapOfEntities(Mockito.any(GetMapOfEntitiesRequest.class)))
                .thenReturn(map);
        deviceStatusCacheBackedInMemoryDAO.initialize();
